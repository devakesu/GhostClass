...
void main() {
  group('EzygoBatchFetcher', () {
    ...
    test('deduplicates request data regardless of map insertion order', () async {
      final fetcher = createFetcher();
      final res = Response<dynamic>(
      ...
      final results = await Future.wait([
        fetcher.fetch(path: '/order', token: 'token', method: 'POST', data: firstPayload),
        fetcher.fetch(path: '/order', token: 'token', method: 'POST', data: secondPayload),
      ]);
