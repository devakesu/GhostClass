...
import {
  ...
  VirtualItem,
} from "@/hooks/notifications/use-notification-virtualizer";
    ...
    <div
      ...
      className={cn(
        ...
        !n.is_read
          ...
          : "bg-transparent border-transparent opacity-70 hover:opacity-100 hover:bg-secondary/5",
      )}
    >
      {!n.is_read && (
      ...
      <div className="flex-1 min-w-0">
        <div className="flex justify-between items-start gap-2 mb-1">
          <h4
            className={cn(
              "text-sm font-semibold leading-tight wrap-break-word",
        ...
        <p
          className={cn(
            ...
            !n.is_read ? "text-muted-foreground" : "text-muted-foreground/70",
          )}
        >
          {n.description}
        </p>
  ...
  const { isSyncing, syncSettled, syncFailed } = useSyncOnMount({
    ...
    onPartialSync: async () => {
      toast.warning("Partial Sync Completed", {
        description:
          "Some notifications couldn't be synced. Your notification list may be incomplete.",
      });
    ...
    onSuccess: async (data) => {
      if ((data.deletions ?? 0) + (data.updates ?? 0) > 0) {
        toast.info("Notifications Updated", {
          description: "New attendance data found.",
        });
      }
      queryClient.invalidateQueries({ queryKey: ["notifications"] });
    },
      ...
      try {
        ...
        captureSentryException(error, {
          tags: {
            ...
            location: "NotificationsClient/handleToggleRead",
          },
          extra: {
            notification_id: id,
            action: "toggle_read",
        ...
        <div className="container mx-auto max-w-2xl px-4 md:px-6 pt-4 md:pt-6 pb-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <h1 className="text-xl font-semibold tracking-tight flex items-center gap-2">
              ...
              {unreadCount > 0 && (
                <span
                  className="bg-primary/10 text-primary text-[11px] font-bold px-1.5 py-0.5 rounded-full"
            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    This will mark all current notifications as read. This
