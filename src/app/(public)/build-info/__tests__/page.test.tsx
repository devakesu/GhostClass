...
describe('BuildInfoPage', () => {
  ...
  it('should link to GitHub commit and run when repo and IDs are valid', () => {
    ...
    expect(commitLink).toHaveAttribute('href', 'https://github.com/owner/repo/commit/abc123def456');

    const runLink = screen.getByRole('link', { name: '#42' });
    expect(runLink).toHaveAttribute('href', 'https://github.com/owner/repo/actions/runs/12345');
  });
