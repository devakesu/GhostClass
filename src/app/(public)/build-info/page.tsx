...
function getBuildMeta(): BuildMeta {
  ...
  return {
    ...
    container: !!process.env.APP_COMMIT_SHA &&
      process.env.APP_COMMIT_SHA !== "<auto-generated-by-github-actions>",
          ...
          <Card className="bg-neutral-950 border-neutral-800 overflow-hidden">
            ...
            <div className="p-6 font-mono text-sm space-y-3 bg-neutral-950 text-neutral-100">
              ...
              <div>
                ...
                <span
                  className={meta.node_env === "production"
                    ? "text-blue-400"
                    : "text-yellow-400"}
                >
          ...
          <Card className="p-6 bg-muted/30">
            ...
            <div className="space-y-2 text-sm text-muted-foreground">
              ...
              <ul className="list-disc list-inside space-y-1 ml-2">
                <li>
                  <strong>Source Code Verification:</strong>{" "}
                  Links to exact commit and build logs
                </li>
                <li>
                  <strong>SLSA Level 3 Compliance:</strong>{" "}
                  Cryptographic attestations proving build integrity
                </li>
                <li>
                ...
                <li>
                  ...
                  Anyone can verify the build matches the source
                </li>
              </ul>
              <p className="pt-2">
                Learn more about{" "}
