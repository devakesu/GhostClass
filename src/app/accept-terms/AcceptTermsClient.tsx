    ...
    <>
      ...
      <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-linear-to-br from-purple-100 via-purple-50 to-blue-100 dark:from-slate-900 dark:via-purple-900 dark:to-slate-900 p-4">
        ...
        <div className="absolute inset-0 -z-10 overflow-hidden pointer-events-none">
          ...
          {/* Dot grid pattern */}
          <div className="absolute inset-0 opacity-10 dark:opacity-20 bg-[radial-gradient(circle,rgba(0,0,0,0.3)_1px,transparent_1px)] dark:bg-[radial-gradient(circle,rgba(255,255,255,0.8)_1px,transparent_1px)] bg-size-[50px_50px]"></div>
        </div>
