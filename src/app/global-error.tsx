    ...
    <html lang="en">
      ...
      >
        ...
        >
          ...
          >
            We encountered a critical error. This has been automatically
            reported to our team. You can try refreshing the page or return to
            the homepage.
          </p>
          ...
          {error.digest && (
            ...
            >
              Error ID:{" "}
              <code style={{ color: "var(--ge-error-code)" }}>
                {error.digest}
              </code>
            </p>
          )}
